function (fetch_from_git target git_repository)
    set(flag_args ADD_SUBDIRECTORY)
    set(single_value_args GIT_REPOSITORY GIT_TAG URL SOURCE_DIR OUT_ROOT SOURCE_DIRECTORY_VAR BINARY_DIRECTORY_VAR)
    ...
    if (NOT ${lowercase_target}_POPULATED)
        ...
        if (${PARSED_ARGS_SKIP_ADD_SUBDIRECTORY})
            add_subdirectory(${TARGET_SOURCE_DIR} ${TARGET_BINARY_DIR})
        else ()
            message("Skipping add_subdirectory for ${target}")
        endif ()
